...
* otherwise we execute the if block*/if (!hasPermissions(this@SplashActivity, *permissionsString)) {
...
launch the next activity*/
                    Handler().postDelayed({val startAct = Intent(this@SplashActivity,
...
* and now application has nowhere to go. Hence after the execution of ifelse nothing happens i.e either new activity
