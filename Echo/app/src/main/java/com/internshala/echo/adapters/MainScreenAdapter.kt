...
* Here we create an object of Bundle to send the sond details to the fragment so
that we can display the song details there and also play the song*/
            var args = Bundle()
...
/*Note: We have only added the details to the bundle object but we still have to
pass this bundle to the song playing fragment.
* Kindly hold on, we will do it a bit later*/
/*Now after placing the song details inside the bundle, we inflate the song playing
fragment*/
