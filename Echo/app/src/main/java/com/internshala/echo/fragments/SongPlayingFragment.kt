 ...
 */
class SongPlayingFragment : Fragment() {/*Here you may wonder that why did we create two objects namely Statified and
    ...
    object Staticated {
        ...
        fun onSongComplete() {
            if (currentSongHelper?.isShuffle as Boolean) {
                ...
                currentSongHelper?.isPlaying = true} else {
                if (currentSongHelper?.isLoop as Boolean) {
                    ...
                    currentSongHelper?.songArtists = nextSong?.artist
                    currentSongHelper?.songId = nextSong?.songID as Long
                    updateTextViews(currentSongHelper?.songTitle as String,
                            currentSongHelper?.songArtists as String)
                    mediaPlayer?.reset()
                    try {
        ...
        fun updateTextViews(songTitle: String, songArtist: String) {
            var songTitlUpdated = songTitle
            var songArtistUpdated = songArtist
            if (songTitle.equals("<unknown",true)){
                songTitlUpdated = "unknown"
            }
            if (songArtist.equals("unknown",true)){
                songArtistUpdated = "unknown"
            }
            songTitleView?.setText(songTitlUpdated)
...
/*Initialising the database*/
        ...
        try {
            ...
            currentSongHelper?.songArtists = _songArtist
...
action has been performed*/
            ...
            } else {/*If the song was not a favorite, we then add it to the favorites using
the method we made in our database*/
                fab?.setImageResource(R.drawable.favorite_on)
                favoriteContent?.storeAsFavorite(currentSongHelper?.songId?.toInt(),
                        currentSongHelper?.songArtists, currentSongHelper?.songTitle, currentSongHelper?.songPath)
